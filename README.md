...
- [TermRover](https://termrover.sh/) - An Android SSH client built to make working with tmux and Herdr feel great on a phone, with one-tap pane controls, pane-aware text selection, and free Mosh.
...
- [TermRover](https://termrover.sh/) - An iOS SSH client built to make working with tmux and Herdr feel great on a phone, with one-tap pane controls, pane-aware text selection, and free Mosh.
- [Yetty](https://github.com/zokrezyl/yetty) - New generation terminal with remote graphics, remote GUI, rich scrolling buffer, plots, diagrams, etc.
